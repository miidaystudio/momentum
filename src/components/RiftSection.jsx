...
export default function RiftSection({ scrollToSection }) {
  return (
    <div id="rift" className="relative min-h-screen w-full overflow-hidden bg-black font-sans text-white select-none border-t border-zinc-900">
      {/* Background Image (Cosmic Rift & Inverted Cliffs style) */}
      <img
      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-between p-8 md:p-12 lg:p-16">
        ...
        <main className="flex flex-col items-center justify-center text-center">
          ...
          <div className="mt-8 md:mt-12">
            <button 
              onClick={() => scrollToSection('cavern')}
        ...
        <footer className="flex items-end justify-between">
          ...
          <div className="flex items-baseline font-bold">
            <span className="text-2xl md:text-3xl text-[#F7AB1E] tracking-tighter font-hero-heading">03</span>
