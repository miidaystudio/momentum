...
export default function HorizonSection({ scrollToSection }) {
  return (
    <div id="horizon" className="relative min-h-screen w-full overflow-hidden bg-black font-sans text-white select-none border-t border-zinc-900">
      {/* Background Image (Floating Sandstone Canyon & Embers style) */}
      <img
        src="https://images.unsplash.com/photo-1506318137071-a8e063b4bec0?q=80&w=2000&auto=format&fit=crop"
        alt="Floating Sandstone Canyon"
      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-between p-8 md:p-12 lg:p-16">
        ...
        <footer className="flex items-end justify-between">
          ...
          <div className="flex items-baseline font-bold">
            <span className="text-2xl md:text-3xl text-[#F7AB1E] tracking-tighter font-hero-heading">02</span>
